...
if (!class_exists('Wordpress_Maintenance_Mode_Admin')) {

    class Wordpress_Maintenance_Mode_Admin
    {
        ...
        public function add_plugin_menu()
        {
            $this->plugin_screen_hook_suffix = add_options_page(
                __('Maintenance Mode', $this->plugin_slug),
                __('Maintenance Mode', $this->plugin_slug),
                'manage_options',
                $this->plugin_slug,
         ...
         * - bug discovered by cokemorgan: https://github.com/OffPe/wordpress-maintenance-mode/issues/56
         *
         * @since 2.0.3
        ...
        public function admin_footer_text($text)
        {
            ...
            if ($this->plugin_screen_hook_suffix == $screen->id) {
                $text = sprintf(__('If you like <strong>Maintenance Mode</strong> please contrinute a %s. A huge thank you from Maintenance Mode makers in advance!', $this->plugin_slug), '<a href="https://github.com/OffPe/wordpress-maintenance-mode" class="wpmm_rating" target="_blank">star</a>');
            }
